...
const PortfolioTable = ({ portfolio }) => {
  return (
    <div>
      ...
      <Segment attached style={{ padding: 8 }}>
        <Table celled>
          <Table.Header>
            <Table.Row>
              ...
              <Table.HeaderCell textAlign='center'>Unrealized Gain</Table.HeaderCell>
            ...
            {portfolio.map(asset => {
              ...
              return (
                <Table.Row key={asset.name}>
                  ...
                  <Table.Cell textAlign='center'>$ {asset.price.toFixed(2)}</Table.Cell>
                  <Table.Cell textAlign='center'>$ {asset.marketValue.toFixed(2)}</Table.Cell>
                  <Table.Cell textAlign='center'>$ {asset.averageCost.toFixed(2)}</Table.Cell>
                  <Table.Cell textAlign='center'>$ {asset.bookValue.toFixed(2)}</Table.Cell>
